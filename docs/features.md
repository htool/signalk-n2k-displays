...
| F9 | n2k-displays | Control webapp in `public/` | [0001](adr/0001-intent-and-actuation-paths.md), [0002](adr/0002-control-off-auto-learning.md), [0003](adr/0003-palettes-are-device-native.md) | off/auto/auto-learning, day/night, intent 0.1, native + palette. PUT v1 paths. Phone-first 48px. Chrome follows `environment.mode`. | done |
