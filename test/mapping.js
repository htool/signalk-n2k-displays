...
describe('F14 mapping table', function () {
  ...
  it('plugin schema has time, sun, and lux', function () {
    ...
    chai.expect(schema.properties.webapp).to.equal(undefined)
    const productKeys = Object.keys(schema.properties)
    productKeys[0].should.equal('raymarine')
    productKeys[1].should.equal('navico')
    productKeys.indexOf('navico').should.be.below(productKeys.indexOf('time'))
    schema.properties.raymarine.title.should.match(/Raymarine ST60/)
    schema.properties.raymarine.properties.st60.title.should.match(/ST60/)
    schema.properties.raymarine.properties.i70.title.should.match(/i70/)
    schema.properties.raymarine.properties.dayColor.title.should.match(/^i70 /)
    schema.properties.raymarine.properties.nightColor.title.should.match(/^i70 /)
    schema.properties.raymarine.properties.groups.title.should.match(/i70/)
    schema.properties.raymarine.properties.groupMappings.title.should.match(/i70/)
    schema.properties.navico.title.should.match(/Navico/)
    schema.properties.navico.properties.groups.title.should.match(/groups/i)
