...
| F1 | signalk-to-nmea2000 | Navico PGN 130845 from SK: backlight, night mode, night color | [0004](adr/0004-converter-owns-n2k-encode.md), [0001](adr/0001-intent-and-actuation-paths.md), [0003](adr/0003-palettes-are-device-native.md) | Conversion + n2k JSON tests (percent, Value 4 → night, color 0–3) | done |
...
| F3 | n2k-displays | Glass paths `electrical.displays.{brightness,mode,control}` published and PUT | [0001](adr/0001-intent-and-actuation-paths.md), [0002](adr/0002-control-off-auto-learning.md) | PUT handlers; meta; no new N2K emit | done |
...
| F8 | n2k-displays | Power-on resync | [0002](adr/0002-control-off-auto-learning.md) | Re-apply last glass brightness and mode when a configured device path appears | done |
| F9 | n2k-displays | Control webapp in `public/` | [0001](adr/0001-intent-and-actuation-paths.md), [0002](adr/0002-control-off-auto-learning.md), [0003](adr/0003-palettes-are-device-native.md) | Manual/Auto/Learning, day/night, brightness 0.1, native + palette. PUT v1 paths. Phone-first 48px. Chrome follows the phone light/dark setting. | done |
...
| F11 | bandg-displaydaynight | Stub: map blob PUT onto glass brightness and mode; no HEX 130845 | [0004](adr/0004-converter-owns-n2k-encode.md) | Plugin does not emit N2K. README says survivor is n2k-displays. | done |
